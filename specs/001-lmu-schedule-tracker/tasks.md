...
- [x] T082 [US5] Integration test for favorites persistence in __tests__/integration/favorites-persistence.test.ts (add favorite, restart app, verify persisted)
...
>>>>>>> claude/implement-favorite-races-01RaX9NFnWE9JpktQEHaMwCr
